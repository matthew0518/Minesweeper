...
DISTDIR = /home/mmarbin/CS3307/Mine2/.tmp/minesweeper1.0.0
LINK          = g++
...
SOURCES       = main.cpp \
		Tile.cpp \
		Minesweeper.cpp qrc_resources.cpp \
		moc_Tile.cpp \
		moc_Minesweeper.cpp
OBJECTS       = main.o \
		Tile.o \
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		minesweeper.pro Tile.h \
		Minesweeper.h main.cpp \
		Tile.cpp \
		Minesweeper.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Tile.h Minesweeper.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp Tile.cpp Minesweeper.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_Tile.cpp moc_Minesweeper.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Tile.cpp moc_Minesweeper.cpp
moc_Tile.cpp: Tile.h \
		moc_predefs.h \
		/usr/lib/qt6/libexec/moc
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/mmarbin/CS3307/Mine2/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/mmarbin/CS3307/Mine2 -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/11 -I/usr/include/x86_64-linux-gnu/c++/11 -I/usr/include/c++/11/backward -I/usr/lib/gcc/x86_64-linux-gnu/11/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include Tile.h -o moc_Tile.cpp
